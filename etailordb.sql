...
//======================================products============================
update products set supplier_id=2 where id=1;
update products set supplier_id=1 where id=2;
update products set supplier_id=3 where id=3;
update products set supplier_id=5 where id=4;
update products set supplier_id=7 where id=5;
update products set supplier_id=8 where id=6;
update products set supplier_id=2 where id=7;
update products set supplier_id=9 where id=8;
update products set supplier_id=10 where id=9;
update products set supplier_id=1 where id=10;
update products set supplier_id=6 where id=11;
update products set supplier_id=5 where id=12;
update products set supplier_id=4 where id=13;
update products set supplier_id=3 where id=14;
update products set supplier_id=9 where id=15;
update products set supplier_id=3 where id=16;
update products set supplier_id=7 where id=17;
update products set supplier_id=1 where id=18;
update products set supplier_id=2 where id=19;
update products set supplier_id=5 where id=20;
...
alter table products add column description varchar(5000);
